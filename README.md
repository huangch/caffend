...
![VNet Result: LA cineMRI](./vnet_result_cineMRI.png=250x)
![VNet Result: Liver CT](./vnet_result_LiverCT.png=250x)
![VNet Result: Prostate MRI](./vnet_result_ProstateMRI.png=250x)
